...
// api key from superheroapi => 3458229221122220
const fetchAllSuperHero = async (searchText) => {
  let url = `https://www.superheroapi.com/api.php/3458229221122220/search/${searchText}`;
  try {
...
//showing the search list for entered input
...
// showing all details of searched superhero
...
//   POWERSTATS
  document.querySelector(".powerstats").innerHTML = `
    <li>
        ...
        <span>${data[0].powerstats.intelligence}&percnt;</span>
    </li>
    <li>
        <div>
        ...
        <span>${data[0].powerstats.strength}&percnt;</span>
    </li>
    <li>
        <div>
        ...
        <span>${data[0].powerstats.speed}&percnt;</span>
    </li>
    <li>
        <div>
        ...
        <span>${data[0].powerstats.durability}&percnt;</span>
    </li>
    <li>
        <div>
        ...
        <span>${data[0].powerstats.power}&percnt;</span>
    </li>
    <li>
        <div>
        ...
        <span>${data[0].powerstats.combat}&percnt;</span>
    </li>
    `;
